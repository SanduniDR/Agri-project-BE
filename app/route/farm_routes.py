...
def search_farm():
    ...
    query = Farm.query.filter(
        Farm.farm_name.ilike(f'%{search_query}%') |
        Farm.address.ilike(f'%{search_query}%') |
        Farm.farmer_id.ilike(f'%{search_query}%') |
        Farm.farm_id.ilike(f'%{search_query}%') |
        Farm.type.ilike(f'%{search_query}%') |
        Farm.area_of_field.ilike(f'%{search_query}%') |
        Farm.owner_nic.ilike(f'%{search_query}%') |
        Farm.owner_name.ilike(f'%{search_query}%')
    )
